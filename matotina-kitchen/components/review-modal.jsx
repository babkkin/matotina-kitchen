...
export default function ReviewPage() {
  ...
  // Validate token and prefill name
  useEffect(() => {
            ...
            <>
              ...
              <div className="review-field">
                ...
                <textarea
                  ...
                  placeholder="Tell us about your experience — the food, the service, the event..."
                  value={comment}
          ...
          {status === "submitted" && (
            <div className="success-wrap">
              ...
              <p className="success-sub">
                Your review has been submitted. We truly appreciate you taking the time — it means a lot to our team and helps future clients feel confident choosing Matotina's Kitchen.
              </p>
            </div>
          )}
        </div>
